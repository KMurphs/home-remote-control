...
export const buttonsData: TButtonsData = {
  ...
  mainButtons: [
    ...
    { keyCode: "KEY_VOLUP",   color: "",        icon: "arrow_drop_up",   text: "Up",     ariaLabel: "Up Key",      ariaHidden: false, scaleFactor: 1.7, cssClass: "btn-black" },
    ...
    { keyCode: "KEY_SOURCE",  color: "",        icon: "input",           text: "Source", ariaLabel: "Source Key", ariaHidden: false, scaleFactor: 1,    cssClass: "btn-green" },
    ...
    { keyCode: "KEY_VOLDOWN", color: "",        icon: "arrow_drop_down", text: "Down",   ariaLabel: "Down Key",   ariaHidden: false, scaleFactor: 1.7,  cssClass: "btn-black" },
  ...
  managementButtons: [
    ...
    { keyCode: "",            color: "",        icon: "",                   text: "",       ariaLabel: "",            ariaHidden: false, scaleFactor: 1, cssClass: ".btn-red" },
    { keyCode: "",            color: "",        icon: "",                   text: "",       ariaLabel: "",            ariaHidden: false, scaleFactor: 1, cssClass: ".btn-red" },
    { keyCode: "KEY_POWEROFF",color: "",        icon: "settings_power",     text: "Off",    ariaLabel: "Tools Key",   ariaHidden: false, scaleFactor: 1, cssClass: "btn-red" },
