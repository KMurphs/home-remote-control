...
export class MainControlsComponent implements OnInit {
  ...
  buttons: TButtonControlData[] = [
    { keyCode: "KEY_TOOLS", color: "", icon: "build", text: "Tool", ariaLabel: "Tools Key", ariaHidden: false, scaleFactor: 1.5 },
    { keyCode: "KEY_UP", color: "accent", icon: "arrow_drop_up", text: "Up", ariaLabel: "Up Key", ariaHidden: false, scaleFactor: 3 },
    { keyCode: "KEY_INFO", color: "", icon: "info", text: "Info", ariaLabel: "Info Key", ariaHidden: false, scaleFactor: 1 },

    { keyCode: "KEY_LEFT", color: "accent", icon: "arrow_left", text: "Left", ariaLabel: "Left Key", ariaHidden: false, scaleFactor: 3 },
    { keyCode: "KEY_SOURCE", color: "primary", icon: "list", text: "Source", ariaLabel: "Source Key", ariaHidden: false, scaleFactor: 1 },
    { keyCode: "KEY_RIGHT", color: "accent", icon: "arrow_right", text: "Right", ariaLabel: "Right Key", ariaHidden: false, scaleFactor: 3 },

    { keyCode: "KEY_RETURN", color: "", icon: "backspace", text: "Return", ariaLabel: "Return Key", ariaHidden: false, scaleFactor: 1 },
    { keyCode: "KEY_DOWN", color: "accent", icon: "arrow_drop_down", text: "Down", ariaLabel: "Down Key", ariaHidden: false, scaleFactor: 3 },
